...
const ru: Dict = {
  ...
  hero: {
    ...
    title2: "Один кошелёк.",
    description:
      "Первый кошелёк со встроенным ИИ: ассистент, автоматизации и копитрейдинг перпов на Hyperliquid. Переводы за секунды, обмен по биржевому курсу, вход через соцсети - без скрытых комиссий.",
  ...
  smart: {
    ...
    lead: "Zifrovoy - кошелёк со встроенным ИИ. Спросите ассистента простым языком, настройте автоматизации, повторяйте топ-трейдеров - деньги работают, пока вы заняты своими делами.",
    tagChat: "AI-ассистент",
    fChatTitle: "Спросите что угодно",
    fChatBody:
      "Чат понимает запросы обычным языком: подберёт стратегию, объяснит риски и сам запустит нужное действие.",
    tag1: "AI-автоматизация",
    f1Title: "Алгоритмы вместо эмоций",
    f1Body:
      "ИИ следит за рынком на 100+ сетях круглосуточно, ребалансирует портфель и подсказывает точки входа - без паники.",
    tag2: "Копитрейдинг",
  ...
  info: {
    ...
    card2Title1: "Спросите -",
    card2Title2: "он сделает.",
    card2Body:
      "Встроенный AI-ассистент понимает обычный язык: подберёт стратегию, объяснит риски и сам выполнит действие за вас.",
...
const en: Dict = {
  ...
  hero: {
    badge: "AI-powered wallet",
    title1: "All assets.",
    title2: "One wallet.",
    description:
      "The first wallet with AI built in: an assistant, automations and copy-trading perps on Hyperliquid. Send in seconds, swap at exchange rates, sign in with social - no hidden fees.",
  ...
  smart: {
    eyebrow: "AI-powered wallet",
    heading1: "Smart income -",
    heading2: "on autopilot.",
    lead: "Zifrovoy is a wallet with AI built in. Ask the assistant in plain language, set up automations, copy top traders - your money works while you get on with your day.",
    tagChat: "AI assistant",
    fChatTitle: "Just ask",
    fChatBody:
      "Chat understands plain language: it finds a strategy, explains the risks and runs the action for you.",
    tag1: "AI automation",
    f1Title: "Algorithms, not emotions",
    f1Body:
      "AI watches the market across 100+ chains around the clock, rebalances and surfaces entry points - no panic.",
    tag2: "Copy trading",
  ...
  info: {
    ...
    card2Title1: "Just ask -",
    card2Title2: "it's done.",
    card2Body:
      "The built-in AI assistant understands plain language: it finds a strategy, explains the risks and runs the action for you.",
...
const kk: Dict = {
  ...
  hero: {
    ...
    title2: "Бір әмиян.",
    description:
      "Ішіне жасанды интеллект кірістірілген алғашқы әмиян: ассистент, автоматтандырулар және Hyperliquid-те перптерді копитрейдинг. Секундтарда аударымдар, биржалық бағам бойынша айырбас, әлеуметтік желілермен кіру - жасырын комиссияларсыз.",
    cta: "Тегін бастау",
  },
  stats: {
  ...
  smart: {
    ...
    lead: "Zifrovoy - ішіне жасанды интеллект кірістірілген әмиян. Ассистенттен қарапайым тілмен сұраңыз, автоматтандырулар орнатыңыз, үздік трейдерлерді қайталаңыз - сіз өз ісіңізбен айналысып жүргенде ақша жұмыс істейді.",
    tagChat: "AI-ассистент",
    fChatTitle: "Кез келген нәрсені сұраңыз",
    fChatBody:
      "Чат қарапайым тілдегі сұрауларды түсінеді: стратегияны таңдайды, тәуекелдерді түсіндіреді және қажет әрекетті өзі орындайды.",
    tag1: "AI-автоматтандыру",
    f1Title: "Эмоцияның орнына алгоритмдер",
    f1Body:
      "ИИ нарықты 100+ желіде тәулік бойы бақылайды, портфельді ребаланстайды және кіру нүктелерін ұсынады - дүрбелеңсіз.",
    tag2: "Копитрейдинг",
  ...
  info: {
    ...
    card2Title1: "Сұраңыз -",
    card2Title2: "ол жасайды.",
    card2Body:
      "Кірістірілген AI-ассистент қарапайым тілді түсінеді: стратегияны таңдайды, тәуекелдерді түсіндіреді және әрекетті өзі орындайды.",
...
const ky: Dict = {
  ...
  hero: {
    ...
    title2: "Бир капчык.",
    description:
      "Ичине жасалма интеллект киргизилген биринчи капчык: ассистент, автоматташтыруулар жана Hyperliquid'те перптерди копитрейдинг. Секунд ичинде которуулар, биржалык курс боюнча алмашуу, социалдык тармактар аркылуу кирүү - жашыруун комиссиясыз.",
    cta: "Бекер баштоо",
  },
  stats: {
  ...
  smart: {
    ...
    lead: "Zifrovoy - ичине жасалма интеллект киргизилген капчык. Ассистенттен жөнөкөй тил менен сураңыз, автоматташтырууларды жөндөңүз, мыкты трейдерлерди кайталаңыз - сиз өз ишиңиз менен алек болуп жүргөндө акча иштейт.",
    tagChat: "AI-ассистент",
    fChatTitle: "Каалаганды сураңыз",
    fChatBody:
      "Чат жөнөкөй тилдеги суроолорду түшүнөт: стратегияны тандайт, тобокелдиктерди түшүндүрөт жана керектүү аракетти өзү аткарат.",
    tag1: "AI-автоматташтыруу",
    f1Title: "Эмоциянын ордуна алгоритмдер",
    f1Body:
      "ИИ рынокту 100+ тармакта сутка бою байкайт, портфелди ребаланстайт жана кирүү чекиттерин сунуштайт - дүрбөлөңсүз.",
    tag2: "Копитрейдинг",
  ...
  info: {
    ...
    card2Title1: "Сураңыз -",
    card2Title2: "ал жасайт.",
    card2Body:
      "Киргизилген AI-ассистент жөнөкөй тилди түшүнөт: стратегияны тандайт, тобокелдиктерди түшүндүрөт жана аракетти өзү аткарат.",
    card3Title1: "Комиссиялар",
...
const uz: Dict = {
  ...
  hero: {
    ...
    title2: "Bitta hamyon.",
    description:
      "Sun'iy intellekt o'rnatilgan birinchi hamyon: assistent, avtomatlashtirishlar va Hyperliquid'da perplar uchun copy trading. Soniyalarda o'tkazmalar, birja kursi bo'yicha ayirboshlash, ijtimoiy tarmoqlar orqali kirish - yashirin komissiyalarsiz.",
    cta: "Bepul boshlash",
  },
  stats: {
  ...
  smart: {
    ...
    lead: "Zifrovoy - sun'iy intellekt o'rnatilgan hamyon. Assistentdan oddiy tilda so'rang, avtomatlashtirishlarni sozlang, eng yaxshi treyderlarni takrorlang - siz o'z ishingiz bilan band bo'lganingizda pul ishlaydi.",
    tagChat: "AI-assistent",
    fChatTitle: "Shunchaki so'rang",
    fChatBody:
      "Chat oddiy tildagi so'rovlarni tushunadi: strategiyani tanlaydi, risklarni tushuntiradi va kerakli amalni o'zi bajaradi.",
    tag1: "AI-avtomatlashtirish",
    f1Title: "Hissiyot o'rniga algoritmlar",
    f1Body:
      "AI bozorni 100+ tarmoqda kechayu kunduz kuzatadi, portfelni qayta balanslaydi va kirish nuqtalarini taklif qiladi - vahimasiz.",
    tag2: "Copy trading",
  ...
  info: {
    ...
    card2Title1: "So'rang -",
    card2Title2: "u bajaradi.",
    card2Body:
      "O'rnatilgan AI-assistent oddiy tilni tushunadi: strategiyani tanlaydi, risklarni tushuntiradi va amalni o'zi bajaradi.",
