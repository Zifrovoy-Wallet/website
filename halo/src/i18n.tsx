...
const ru: Dict = {
  ...
  perps: {
    ...
    heading1: "Копитрейдинг перпов",
    heading2: "ончейн.",
    lead: "Подписывайтесь на топ-трейдеров Hyperliquid — и каждая их сделка автоматически появляется в вашем кошельке. Полностью ончейн, без передачи средств и ключей кому-либо.",
...
const en: Dict = {
  ...
  perps: {
    ...
    heading1: "Perps copy trading",
    heading2: "onchain.",
    lead: "Follow top Hyperliquid traders — every trade lands in your wallet automatically. Fully onchain, no custody of funds or keys.",
    liveBadge: "Live · Hyperliquid",
...
const kk: Dict = {
  ...
  perps: {
    ...
    heading1: "Перптерді копитрейдинг",
    heading2: "ончейн.",
    lead: "Hyperliquid үздік трейдерлеріне жазылыңыз — олардың әрбір мәмілесі сіздің әмияныңызда автоматты түрде пайда болады. Толығымен ончейн, қаражат пен кілттерді ешкімге бермей.",
    liveBadge: "Live · Hyperliquid",
    featTitle1: "Бір басу —",
...
const ky: Dict = {
  ...
  perps: {
    ...
    heading1: "Перптерди копитрейдинг",
    heading2: "ончейн.",
    lead: "Hyperliquid'тин мыкты трейдерлерине жазылыңыз — алардын ар бир бүтүмү капчыгыңызда автоматтык түрдө пайда болот. Толугу менен ончейн, акча менен ачкычтарды эч кимге бербей.",
    liveBadge: "Live · Hyperliquid",
...
const uz: Dict = {
  ...
  perps: {
    ...
    heading1: "Perplar uchun copy trading",
    heading2: "onchain.",
    lead: "Hyperliquid'ning eng yaxshi treyderlariga obuna bo'ling — ularning har bir bitimi hamyoningizda avtomatik paydo bo'ladi. To'liq onchain, mablag' va kalitlarni hech kimga bermay.",
    liveBadge: "Live · Hyperliquid",
